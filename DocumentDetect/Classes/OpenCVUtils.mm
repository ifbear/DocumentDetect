...
- (instancetype)init
{
    self = [super init];
    if (self) {
        NSString *bundlePath = [[NSBundle bundleForClass:self.class] pathForResource:@"DocumentDetect" ofType:@"bundle"];
        NSString *modelPath = [bundlePath stringByAppendingPathComponent:@"hed_graph.pb"];
